...
import algs13.Queue.Node;

/**
 * CSC402Homework7 version 1.0
 * 
 * Your Name goes here: Giries Hattar 
 * You class section goes here: Section 901 
 * 
 * 
 * this class implements a Dequeue - a double-ended queue, where elements may be
 * added or removed from either end. pushLeft means add a value to the left end,
 * pushRight means add a value to the right end, similarly for popLeft, popRight
 * 
 * The dequeue is implemented using a doubly-linked list: each node has a link
 * to the successor and predecessor nodes. The instance variable first is used
 * to 'point' at the left-most node The instance variable last is used to
 * 'point' at the right-most node The instance variable N keeps a count of the
 * size of the Dequeue
 * 
 ...
 * included.
 * 
 * You should not use any loops or recursions, except in "delete" Delete may use
 * one loop or recursive helper. You may NOT use any other Java classes without
 * permission.
 * 
 ...
 * if there other tests that are warranted.
 * 
...
public class CS402Dequeue {
	 ...
	 * popLeft
	 * 
	 * remove the leftMost node in the Dequeue, return the item preconditions: none
	 *
	 */
	public double popLeft() {
		// System.out.println("popping left");
		if (N == 0)
	...
	public double popRight() {
		// System.out.println("popping right");
		if (N == 0)
	 ...
	 * After execution, "that" should be empty. See the tests in the main program.
	 *
	 * Do not use a loop or a recursive definition. This method should create no new
	 * Nodes; it may not call pushLeft or pushRight.
	 * 
	 */
	 ...
	 * Delete
	 * 
	 * delete and return the kth element from the left (where k is between 0 and
	 * N-1). See the tests in the main program.
	 *
	 * You may use a loop or a recursive definition here. This method should create
	 * no new Nodes; it may not call pushLeft, pushRight, popLeft, popRight
	 * 
	 */
