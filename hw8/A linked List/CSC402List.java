...
public class CSC402List {
	...
	public CSC402List ( ) {   // the List constructor
	...
	public int get(int i) {
		...
		return got; // ToDo 3 fix this
	}

	// remove
	//
	// delete and return the element in position k (where k is between 0 and N-1
	// inclusive)
	...
	// Hint: for an array, you will need to move every value to the right of
	// position k, left one position
	...
	// list may be empty
	// Hint: for an array, you will need to move every value to the right of
	// position k, right one position
	// for an array, this operation may require resizing the array. A resize method
	// is provided for you;
	...
	public static void testremoveMethod() {
		...
		removeTest(new int[] {9,8,7,6,5 }, 1,8);
	...
	public static void print( CSC402List a) {
	...
	//
	//  To Do 0.3
	public static CSC402List createFrom(int[] data) {

		CSC402List result = new CSC402List ();
