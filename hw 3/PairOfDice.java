...
*  ------------------------------------------------------
*  The average number of rolls to get a 7 or 11 was 4.492
...
//------------------------------------- testing program ---------------------
	...
	public static double experimentOne( PairOfDice x) {
		...
		for(int i = 0; i < 1000000; i++)
			{
				x.roll();
					if(x.sevenEleven() == true)
						c++;
			}	
		double d = 1000000 / c; // should be around 4.5 = 1,000,000 / 222,222
		return d; // ToDo 3   
	...
	public static double experimentTwo( PairOfDice x) {
		...
		for(int i = 0; i < 1000000; i++)
			{
				x.roll();
				if(x.isDoubles() == true && x.doubleOdd() == true) {
						c++;
				}
			}
		double percentage = c / 1000000; // should be around 0.083 = 3/36
		return percentage;  // ToDo 2:
	}
